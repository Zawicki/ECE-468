...
void assemble_cmpi(string op1, string op2, string saved_reg, string output_reg, int * curr_reg);
void assemble_cmpr(string op1, string op2, string saved_reg, string output_reg, int * curr_reg);
